...
export function RegistrationModal({ isOpen, onClose }: RegistrationModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setErrorMsg('Something went wrong. Please try again or email info@ecosenssehealth.co.uk directly.');
    } finally {
        ...
        >
          ...
          <div className="relative overflow-hidden rounded-t-3xl" style={{
            ...
            <div className="inline-flex items-center gap-[7px] px-3 py-[5px] rounded-full mb-4 relative z-[1]" style={{
              ...
              <span className="text-[20px] font-bold tracking-[0.12em] uppercase" style={{ color: '#14C0C6' }}>
                Pilot Programme · May 2026
              </span>
            </div>
          ...
          <div className="p-10" style={{ display: showSuccess ? 'none' : 'block' }}>
            <form onSubmit={handleSubmit}>
              ...
              <div className="flex flex-col gap-2 mb-4">
                {[
                  { value: 'Essentials Plan (£7.5/month per client)', title: 'Essentials Plan', desc: '3-regulator compliance + Family Portal (bundled)', price: '£7.5/mo per client' },
                  { value: 'Operations Plan (£15 agency)', title: 'Operations Plan', desc: 'Essential + Rostering, Payroll, ops(eMar), Family Portal', price: '£15/mo' },
                  { value: 'Infracture Plan (£35/month)', title: 'Infrastructure Plan', desc: 'Essentials + Operations + NHS, wearables, AI', price: '£35/mo' }
                ].map((tier) => (
                  <label
                    key={tier.value}
          ...
          {showSuccess && (
            <div className="text-center p-12 px-8">
              ...
              <p className="text-sm text-[#64748B] leading-[1.7] max-w-md mx-auto mb-6">
                ...
                <strong className="text-[#0A2342] font-semibold"> Ouragent will be in touch within 48 hours</strong> to discuss next steps.
